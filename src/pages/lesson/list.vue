      ...
      >
        ...
        <div class="lesson-content">
          ...
          <p>
            ...
            <span class="number"
              ><i class="iconfont">&#xe607;</i>{{ item.persons || 0 }}</span
            >
          ...
          <p class="price">
            <span v-if="item.isDiscount" class="new"
              >¥{{ item.discountPrice }}</span
            >
            <span class="old" :class="{ 'is-discount': item.isDiscount }"
              >¥{{ item.price }}</span
            >
            <span class="price-right">
              <span
                v-if="!item.isBuy"
                class="cart"
                @click.stop="handleAddCartClick(item)"
                >加入购物车</span
              >
            </span>
          </p>
